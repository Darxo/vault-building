...
{
	// We effectively inherit from the vanilla WorldTownScreenShopDialogModule
	var shopModule = new WorldTownScreenShopDialogModule(_parent);
	for (var attrname in shopModule)
	{
		// We skip functions, if they already exist here (allows overwriting effectively)
...
// Hooks
{
	...
	WorldTownScreenVaultDialogModule.prototype.show = function (_withSlideAnimation)
	{
		WorldTownScreenShopDialogModule.prototype.show.call(this, _withSlideAnimation);

		// Vanilla creates their popup dialogs for all shop-like classes. Triggereing it there, will create a husk here too, because we inherit the shop class
		// So we need to clean up any popup dialog whenever we show this screen
...
{
	// By overwriting this, we also disable the vanilla feature of asking for confirmation when "selling" important items
