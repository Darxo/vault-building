::mods_hookDescendants("items/item", function ( o ) // copied from Taro Stronghold mod
{
    ...
    {
        if (("State" in this.World) && this.World.State != null && this.World.State.getCurrentTown() != null && this.World.State.getCurrentTown().m.CurrentBuilding != null && this.World.State.getCurrentTown().m.CurrentBuilding.m.ID == "building.vault")
        {
            return 0.0;
        }
        else
